...
-- model:
cmd:option('-layers', 1, 'Number of stochastic layers in DGM')
cmd:option('-dimhid', 256,'Dimensionality of hidden units')
cmd:option('-dimstoc', 128,'Dimensionality of hidden units')
-- training:
...
cmd:option('-batch', 128, 'mini-batch size (1 = pure stochastic)')
